...
3. **NEVER commit AI-generated plan files** (e.g., design docs generated by Superpowers typically in `docs/superpowers/` or similar agent workflows). These are ephemeral agent guidance, not proper project documentation.
